...
C==================== AFTER STEP =====================
      ...
      write(70,*) 'zone i=', nx-i_step, ', j=', j_step, ', f=point'
      ...
      write(80,*) 'zone i=', nx-i_step, ', j=', j_step, ', f=point'
      ...
      write(90,*) 'zone i=', nx-i_step, ', j=', j_step, ', f=point'
      ...
      write(100,*) 'zone i=', nx-i_step, ', j=', j_step, ', f=point'
...
!**********************************************************************!
     ...
     $  +(u(i,j-1)*dy(j)+u(i,j)*dy(j-1))/dyb(j))
      ...
      write(130,*) 'zone i=', nx-i_step, ', j=', j_step, ', f=point'
