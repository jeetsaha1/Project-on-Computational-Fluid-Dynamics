...
!**********************************************************************!
      ...
      phi  = 0.01      ! nanoparticle volume fraction (0 if pure fluid)
      chi  = 1.0E-06      ! viscous dissipation coefficient (set as per model)
      Knff = 1.2      ! effective thermal conductivity ratio

      U0   = 0.2     ! inlet velocity (matches u(1,j)=2.0-u(2,j))
...
!--------- Thermal entropy (heat transfer irreversibility) ------------!
...
!--------- Frictional entropy (viscous dissipation) -------------------!

            Sf(i,j) = (chi / ((1.0-phi)**2.5)) * (
...
!**********************************************************************!
      ...
      write(431,*) 'Normalized average entropy generation'
      write(431,*) Sgen_avg_nd
      close(431)
